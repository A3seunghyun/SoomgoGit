...
public class GosuKnowhowPostDto {
	private String name;
	...
	public GosuKnowhowPostDto(String name, String explain, String img, String title, int postIdx, String startPost,
			int serviceIdx, int mainIdx, String contents, String headerPost, String mainImg1, String mainImg2,
			String mainImg3, String serviceTitle, String writeDate, String commuTitle) {
		this.name = name;
