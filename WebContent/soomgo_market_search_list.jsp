			...
			<div id="app-header" class="center">
				<div id="global-navigation-bar" class="center">
					<div id="desktop-header" class="center">
						<div id="left-section">
							<div id="logo">
								<a href="soomgo_main.html"><img src="https://assets.cdn.soomgo.com/icons/logo/navigation_logo.svg"></a>
							</div>
							<nav>
								<ul id="nav-left-list">
							...
							<div id="service-searcher-desktop">
								<form id="global-search-bar">
									<div class="global-search-bar-input-group">
										...
										<input type="text" class="form-control" placeholder="어떤 서비스가 필요하세요?">
