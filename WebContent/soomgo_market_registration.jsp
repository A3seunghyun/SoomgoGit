...
<title>숨고 마켓 상품 등록하기 -승현</title>
	...
	<link rel="stylesheet" href="css/soomgo_market_registration.css">
...
/* 						let inputNewFile = '<input type="file" name="ygygygyg" class="custom-file-input" id="custom-file-label-'+cnt+'" onchange="uploadFile(this)"/>'															
										+'	<label for="custom-file-label-'+cnt+'" class="custom-file-label">'
										+'		<span class="d-block"></span>'
										+'	</label>';
 */
						/*  						let inputNewFile = '<input type="file" class="custom-file-input" id="detatil-file-label-' + cnt + '" onchange="detailUploadFile(this)"/>'
										+'<label for="detatil-file-label-' + cnt + '" class="custom-file-label">'
										+'<span class="d-block"></span>'
										+'</label>'; */
...
/* 				$.ajax({
					type : "POST" ,
					traditional: true ,
					url : "/WebProject1/SoomgoMarketRegistrationServlet" ,
					data : {insert : insert} , 
					datatype : 'json' ,
